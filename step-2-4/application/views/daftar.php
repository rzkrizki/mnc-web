        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header bg-transparent mb-0">
                    <h5 class="text-center"><span class="font-weight-bold text-primary">PLEASE REGISTER HERE</span></h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button class="btn btn-success btn-block" onclick="checkData()"><b>Save</b></button>
                    </div>
                </div>
            </div>
        </div>
