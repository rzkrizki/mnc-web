    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control datepicker" id="publish_date" name="publish_date" value="<?= $result->publish_date ?>">
            </div>
            <div class="col-md-6">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="form-control" value="<?= $result->description ?>"><?= $result->description ?></textarea>
            </div>
            <div class="col-md-6">
                <label for="content">Content</label>
                <textarea name="content" id="content" cols="30" rows="10" class="form-control" value="<?= $result->content ?>"><?= $result->content ?></textarea>
            </div>
        </div>
        <div class="mt-4">
            <button class="btn btn-success btn-block" onclick="checkData()"><b>Update Article</b></button>
        </div>
    </div>
</div>
